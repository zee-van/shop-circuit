...
import { updatingSellerProfile } from '../Axios';
...
function EditProfile() {
    ...
    const changeProfile = async (e) => {
        e.preventDefault();
        try {
            const uploadedSucces = await updatingSellerProfile({
                username,
                image
            })
    ...
    return (
        ...
        <>
            ...
            <div className='flex justify-center items-center h-screen'>
                <form action='/sellers/edit' method='post' onSubmit={changeProfile} encType='multipart/form-data' className='p-4 border-2 bg-zinc-900 border-zinc-950 flex-col flex w-[30rem] gap-4 rounded-md relative'>
